...
int conectarseADestino(proceso destino){
     ...
     if(socketDestino!=-1){
    	 log_info(logger,"Se ha conectado el GameBoy a un proceso.\nTipo de proceso: %s\nIP: %s\nPUERTO: %s\nSocket:%d",
    	...
    	switch(tipoMensaje){
    		case NEW:{
    			...
    			//./gameboy GAMECARD NEW_POKEMON [POKEMON] [POSX] [POSY] [CANTIDAD] [ID_MENSAJE]
    				...
    				datosMensaje.sizeMensaje=sizeof(uint32_t)*4 +mensaje.longPokemon;
    				...
    				memcpy(datosMensaje.mensaje+offset,&(mensaje.posicionX),sizeof(uint32_t));
    				offset+=sizeof(uint32_t);
    				memcpy(datosMensaje.mensaje+offset,&(mensaje.posicionY),sizeof(uint32_t));
    				offset+=sizeof(uint32_t);
    				memcpy(datosMensaje.mensaje+offset,&(mensaje.cantPokemon),sizeof(uint32_t));
    			    offset+=sizeof(uint32_t);
    			    enviarMensajeASuscriptor(socketDestino,tipoMensaje,datosMensaje);
    		...
    		case APPEARED:{
    			...
    			if(destino==BROKER){
    			    ...
    			    size=sizeof(uint32_t)*3+mensaje.longPokemon;
      				...
      				enviarMensajeABroker(socketDestino,tipoMensaje,atoi(argv[6]),size,&mensaje);
      				log_info(logger,"Se envió un mensaje a la cola %s del proceso %s",argv[2],argv[1]);
   		 			free(mensaje.pokemon);
    			}
    			else{
    			//./gameboy TEAM APPEARED_POKEMON [POKEMON] [POSX] [POSY]
    			    ...
    			    mensaje.pokemon=malloc(mensaje.longPokemon);
	 				...
	 				mensaje.posicionX=atoi(argv[4]);
      				...
      				datosMensaje.id=-10;
       				datosMensaje.idCorrelativo=-1;
       				datosMensaje.sizeMensaje=sizeof(uint32_t)*3 +mensaje.longPokemon;
       				datosMensaje.mensaje=malloc(datosMensaje.sizeMensaje);
       				memcpy(datosMensaje.mensaje+offset,&(mensaje.longPokemon),sizeof(uint32_t));
       				offset+=sizeof(uint32_t);
       				memcpy(datosMensaje.mensaje+offset,mensaje.pokemon,mensaje.longPokemon);
    		...
    		case CAUGHT:{
    			...
    			//./gameboy BROKER CAUGHT_POKEMON [ID_MENSAJE] [OK/FAIL]
    				...
    				enviarMensajeABroker(socketDestino,tipoMensaje,atoi(argv[3]),size,&mensaje);
    				log_info(logger,"Se envió un mensaje a la cola %s del proceso %s",argv[2],argv[1]);
    			}
    			else{
    		...
    		case GET:{
                ...
                //./gameboy GAMECARD GET_POKEMON [POKEMON]
    				...
    				datosMensaje.id=-10;
    				datosMensaje.idCorrelativo=-1;
    				datosMensaje.sizeMensaje=sizeof(uint32_t)+mensaje.longPokemon;
    				datosMensaje.mensaje=malloc(datosMensaje.sizeMensaje);
    				memcpy(datosMensaje.mensaje+offset,&(mensaje.longPokemon),sizeof(uint32_t));
    				offset+=sizeof(uint32_t);
    				memcpy(datosMensaje.mensaje+offset,mensaje.pokemon,mensaje.longPokemon);
